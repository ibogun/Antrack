...
tracker_command = strcat(cDir,'/build/bin/struck_vot2014 --feature=hogANDhist --kernel=int --lambda_s=0 --lambda_e=0.4 --filter=1 --updateEveryNframes=3 --b=10 --P=10 --Q=13 --R=13');
