 ...
 */
tuple<mat, mat, mat> OLaRank_old::processNew(mat &newX, mat &y_hat,
...
int OLaRank_old::budgetMaintance() {
    ...
    // std::cout<<"Before. Number of  support Vectors : "<<test<<" out of:
    ...
    //		if (absSum<1e-20){
    //            //std::cout<<"Deleting the whole row
    //            "<<max(abs(this->S[i].beta))<<std::endl;
    //
    ...
    if (numberOfNegativeSP == 1) {
        ...
        //
        //                    std::cout<<"Gradient is not correct in IF
        //                    expected: "<<grad<<" got:
        //                    "<<this->S[ii].grad(yy)<<std::endl;
        //                }
        //            }
        //        }
        ...
        //                if(abs(grad-this->S[ii].grad(yy)>0.0000001)){
        //
        //                    std::cout<<"Gradient is not correct in ELSE
        //                    expected: "<<grad<<" got:
        //                    "<<this->S[ii].grad(yy)<<std::endl;
        //                }
        //            }
...
double OLaRank_old::kernel_fast(mat &x, mat &y_loc, int y, int frameNumber_1,
                                mat &xp, mat &yp_loc, int yp,
                                int frameNumber_2) {
 ...
 * @param y_hat					- label
 */
void OLaRank_old::process(mat &newX, mat &y_hat, int y_hat_label,
                          int frameNumber) {
