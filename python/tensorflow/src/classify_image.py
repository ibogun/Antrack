...
# Taken from the https://github.com/AKSHAYUBHAT/VisualSearchServer/blob/master/inception.py lines 126-145
def get_batch_from_path(path,batch_size = 1000):
    """
    Args:
...
# Taken from the https://github.com/AKSHAYUBHAT/VisualSearchServer/blob/master/inception.py lines 161-172
...
def run_inference_on_image(image):
  ...
  with tf.Session() as sess:
    ...
    next_to_last = sess.graph.get_tensor_by_name('pool_3:0')
    print(next_to_last)
