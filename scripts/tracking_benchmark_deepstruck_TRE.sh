#!/bin/bash
#SBATCH --job-name DeepStruck_TRE
#SBATCH --nodes 1
#SBATCH --ntasks-per-node=1
#SBATCH --partition=gpu
#SBATCH --gres=gpu:1
#SBATCH --mem-per-cpu=4000
#SBATCH --error=DeepStruck_TRE_Wu2015_.%J.err
#SBATCH --output=DeepStruck_TRE_Wu2015_.%J.out
...
python run_trackers_cached.py -t DeepStruck -e TRE
