#!/bin/bash
#SBATCH --job-name M128L0_15_OPE
#SBATCH --nodes 2
#SBATCH --ntasks-per-node=24
#SBATCH --partition=eternity
#SBATCH --mem-per-cpu=2000
#SBATCH --error=M128L0_15_Wu2015_OPE_.%J.err
#SBATCH --output=M128L0_15_Wu2015_OPE_.%J.out
...
python run_trackers_cached_parallel.py -t M128L0_15 -e OPE -p 48
