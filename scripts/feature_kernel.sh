...
do
	...
	do
		...
		qsub -v P_param=${P},updateEveryNFrames=${updateEveryNFrames},b=${b},filter=${filter_[filter_idx]},Q=${Q},R=${R},prefix=${prefix},feature=${feature_[idx]},kernel=${kernel_[idx]},datasetSaveLocation="/udrive/student/ibogun2010/Research/Results",filter=${filter_[filter_idx]},nThreads=24 filter_experiments.sh
	done
done
